...
- ⚠️ Le DMS privé est Ready, mais le refus LDAP synthétique Dovecot expire dans le chemin libldap asynchrone. Le diagnostic temporaire #3267 active des logs auth sans password et un essai `blocking = yes` durant un second rollout contrôlé privé.
