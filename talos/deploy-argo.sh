#!/bin/bash
# sources : https://github.com/Jojoooo1/k8s-scripts/blob/main/deploy-argo.sh

ARGO_CHART_VERSION="8.5.3"
ARGO_APP_NAME="argocd-helm"
ARGO_HELM_CHART_PATH="https://raw.githubusercontent.com/charchess/vixens/refs/heads/dev/base/argocd-helm/argocd-helm.yaml"
KUBECONFIG=~/vixens/environments/dev/kubeconfig
...
setupSelfManagedArgoCD() {
  kubectl apply -f https://raw.githubusercontent.com/charchess/vixens/refs/heads/dev/base/argocd-helm/argocd-helm.yaml
}
