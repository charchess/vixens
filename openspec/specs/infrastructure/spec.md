...
- **THEN** it SHALL take IP 192.168.201.70

#### Scenario: ArgoCD LB IP allocation prod
- **WHEN** ArgoCD is deployed in prod
- **THEN** it SHALL take IP 192.168.201.71
...
| **vixens-prod** | 192.168.111.190 | perla: 192.168.111.65 / 68:1d:ef:4d:d6:a9 / /dev/nvme0n1&lt;br&gt;peridot: 192.168.111.60-63 / 68:1d:ef:56:d7:bb / /dev/nvme0n1&lt;br&gt;purpuria: 192.168.111.66 / 00:e1:4f:68:0d:f8 / /dev/sda | 192.168.201.71 | 192.168.201.70 | 200 | 200 | Configured, not deployed |
