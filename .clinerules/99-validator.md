...
This rule defines the Validator persona and project standards.

## Role Definition

When the user types `@validator`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/validator.md](.claude/agents/validator.md)

## Usage

Type `@validator` to activate this Validator persona.
