...
def main():
    ...
    overview_rows = [
        {"Category": "✅ OK (Functional)", "Count": str(stats["OK"]), "Total": str(total)},
        {"Category": "❌ NOK (Broken)", "Count": str(stats["NOK"]), "Total": str(total)},
        {"Category": "💤 Hibernated", "Count": str(stats["HIBERNATED"]), "Total": str(total)},
        {"Category": "⚪ Absent", "Count": str(stats["ABSENT"]), "Total": str(total)},
