...
def main():
    ...
    parser.add_argument("--output", default="docs/reports/STATE-ACTUAL.md", help="Output Markdown file path")
    parser.add_argument("--json-output", default="", help="Optional Output JSON file path for raw state data")
    ...
    for app in sorted_apps:
        ...
        # Save raw state for STATUS.md generation
        raw_state[name] = {
            "namespace": ns,
        ...
        profile = "Unknown"
        if mem_lim_bytes > 0:
            if mem_lim_bytes <= 128 * 1024 * 1024: profile = "Micro"
            elif mem_lim_bytes <= 512 * 1024 * 1024: profile = "Small"
            elif mem_lim_bytes <= 2 * 1024 * 1024 * 1024: profile = "Medium"
            else: profile = "Large"
    ...
    if args.dry_run:
        ...
        if args.json_output:
            ...
            print(f"State JSON generated: {args.json_output}")
